...
def main(input_data_path,output_data_path):
    comp='bazel build -c opt --copt -DMESA_EGL_NO_X11_HEADERS mediapipe/examples/desktop/multi_hand_tracking:'
    #명령어 컴파일
    cmd='GLOG_logtostderr=1 ./bazel-bin/mediapipe/examples/desktop/multi_hand_tracking/multi_hand_tracking_landmarks_gpu \--calculator_graph_config_file=mediapipe/graphs/hand_tracking/multi_hand_tracking_desktop_live.pbtxt'
